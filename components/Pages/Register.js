...
<div style={{display:'flex', flexDirection:'row',justifyContent:'center'}}>
                        ...
                        <input style={inputStyle1} type="tel" id="PhoneNo" name="PhoneNo" placeholder="Phone No." required />
                        </div>
                      </div>
                      <div className="inputBx mb-1" style={{ textAlign: 'center' }}>
...
<div  style={{display:'flex', flexDirection:'row',justifyContent:'center'}}>
  <div style={labelStyle}>
                        ...
                        >
                          ...
                          <option style={containerStyle} value="virtual">Virtual Attendance</option>
                        </select>
                        </div>
                      </div>
                      <div className="inputBx mb-1" style={{ textAlign: 'center' }}>
