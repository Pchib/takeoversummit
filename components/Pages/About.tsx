  ...
  <div className="row">
    ...
    <div className="col-lg-5 col-md-6">
      <div className="about-img wow fadeInRight animated animated">
        <img src="assets/img/toa.png" alt=""/>
      </div>
    </div>
    ...
    <div className="col-lg-7 col-md-6">
      <div className="about-content wow fadeInLeft">
        ...
        <h3></h3>
          ...
          <li><i className="ion-android-checkmark-circle"></i> One-Day Networking Extravaganza</li><li><i className="ion-android-checkmark-circle"></i> world Renowned Speakers</li>
        </ul>
