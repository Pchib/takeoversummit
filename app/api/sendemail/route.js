...
export async function POST(req) {
  try {
    const { fullName, email, phoneNo, modeOfParticipation, summitDiscoveryMethod } = await req.json();

    console.log( fullName, email, phoneNo, modeOfParticipation, summitDiscoveryMethod )
    ...
    // await transporter.sendMail(mailOptionsToRegistrant);
    const transporter5 = nodemailer.createTransport({
        ...
        auth: {
          user: "registration@gharvestisland.org",
          pass: "qsqh enhm yyhj lrxj",}
        });
        ...
        const mailOptionsToOrganizers = {
          ...
          to:'MOJI.ALADEOJEBI@GMAIL.COM',
          bcc: 'ugwuisaaciu@gmail.com,Oluwaseun.onagoruwa@gmail.com',
          subject: 'New Registration Form Submission',
          html: `
            <p><strong>Full Name:</strong> ${fullName}</p>
            <p><strong>Email:</strong> ${email}</p>
...
table, td { color: #000000; } #u_body a { color: #0000ee; text-decoration: underline; } @media (max-width: 480px) { #u_content_heading_1 .v-container-padding-padding { padding: 40px 10px 0px !important; } #u_content_heading_1 .v-font-size { font-size: 28px !important; } #u_content_text_1 .v-container-padding-padding { padding: 0px 10px 10px !important; } #u_content_image_3 .v-container-padding-padding { padding: 20px 10px 30px !important; } }
  </style>
...
<!--[if (mso)|(IE)]><td align="center" width="580" style="background-color: #ffffff;width: 580px;padding: 0px;border-top: 10px solid #570909;border-left: 10px solid #570909;border-right: 10px solid #570909;border-bottom: 10px solid #570909;" valign="top"><![endif]-->
<div class="u-col u-col-100" style="max-width: 320px;min-width: 600px;display: table-cell;vertical-align: top;">
<div style="background-color: #ffffff;height: 100%;width: 100% !important;">
<!--[if (!mso)&(!IE)]><!--><div style="box-sizing: border-box; height: 100%; padding: 0px;border-top: 5px solid #ff2828;border-left: 5px solid #ff2828;border-right: 5px solid #ff2828;border-bottom: 5px solid #ff2828;"><!--<![endif]-->
...
<tr>
  <td style="padding-right: 0px;padding-left: 0px;" align="center">
    <a href="https://takeoversummit.gharvestisland.org/" target="_blank">
    <img align="center" border="0" src="https://uicsoft907183173.wordpress.com/wp-content/uploads/2025/02/toats.jpg" alt="image" title="image" style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: inline-block !important;border: none;height: auto;float: none;width: 100%;max-width: 600px;" width="600"/>
    </a>
  </td>
</tr>
</table>
...
<!--[if mso]><table width="100%"><tr><td><![endif]-->
  <h1 class="v-font-size" style="margin: 0px; line-height: 140%; text-align: center; word-wrap: break-word; font-size: 30px; font-weight: 400;"><span><span><span><span><span><span><span><span><strong>Get Ready</strong></span></span></span></span></span></span></span></span></h1>
...
<!--[if mso]><table width="100%"><tr><td><![endif]-->
  <h1 class="v-font-size" style="margin: 0px; line-height: 140%; text-align: center; word-wrap: break-word; font-size: 16px; font-weight: 400;"><span><span><span><span><span><span><span><span>We Await You !</span></span></span></span></span></span></span></span></h1>
<!--[if mso]></td></tr></table><![endif]-->
...
<div class="v-font-size" style="font-size: 14px; font-weight: 400; line-height: 140%; text-align: left; word-wrap: break-word;">
  <p style="line-height: 140%;">Dear ${fullName} ,<br/>Thank you for registering for TakeOver at the Summit 2025.             <br />We are excited to welcome you, as the conference will be impactful, inspirational, and life-transforming.
  </p>
<p style="line-height: 140%;"> </p>
<p style="line-height: 140%;">📅 Date: 5th April, 2025.<br />🕒 Time: 9am<br />📍 Location: Galaxy Hall, Four Points by Sheraton, Victoria Island, Lagos.</p>
<p style="line-height: 140%;"> </p>
<p style="line-height: 140%;">Featuring renowned speakers, informative sessions, and valuable networking opportunities, this conference is not to be missed. Mark your calendar, plan to attend, and prepare for an exceptional experience.
.<br />Looking forward to seeing you at TakeOver at the Summit.
