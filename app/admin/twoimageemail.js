...
export default class page extends Component {
  ...
  handleSubmit = (event) => {
    ...
    var topurl = event.target.topurl.value;
    var topimageurl = event.target.topimageurl.value;
    var bottomurl = event.target.bottomurl.value;
    var bottomimageurl = event.target.bottomimageurl.value;

    // fetch('https://localhost:3001/api/twoimageemail',
    fetch('https://takeoverbackend.onrender.com/api/twoimageemail',
     {
        method: 'POST',
        headers: {
                             ...
                             <div className="container">
                                 <div className="row">
                                     ...
                                     <form action="#"  onSubmit={this.handleSubmit}className="col-md-12 col-sm-12" id="contact-form" role="form">
                                         ...
                                         <div className="col-md-6 col-sm-12 wow fadeIn" data-wow-delay="0.3s">
                                             <input name="topurl" type="text" className="form-control" id="websiteurl" placeholder="topurl"/>
                                         </div> 
                                         <div className="col-md-6 col-sm-12 wow fadeIn" data-wow-delay="0.3s">
                                             <input name="topimageurl" type="text" className="form-control" id="imageurl" placeholder="topimageurl"/>
                                         </div>
                                         <div className="col-md-6 col-sm-12 wow fadeIn" data-wow-delay="0.3s">
                                             <input name="bottomurl" type="text" className="form-control" id="bottomurl" placeholder="bottomurl"/>
                                         </div> 
                                         <div className="col-md-6 col-sm-12 wow fadeIn" data-wow-delay="0.3s">
                                             <input name="bottomimageurl" type="text" className="form-control" id="bottomimageurl" placeholder="bottomimageurl"/>
                                         </div>
                                             <div className="col-md-6 col-sm-12 wow fadeIn" data-wow-delay="0.3s">
